...
# 平台级模型
# 业务上下文 PO
from hei_fastapi_ddd.contexts.auth.infrastructure.persistence import (
    oauth_po as oauth_binding_model,  # noqa: F401
)
...
from hei_fastapi_ddd.contexts.iam.infrastructure.persistence import (
    account_po as iam_account_model,  # noqa: F401
)
from hei_fastapi_ddd.contexts.iam.infrastructure.persistence import (
    client_po as iam_client_model,  # noqa: F401
)
from hei_fastapi_ddd.contexts.iam.infrastructure.persistence import (
    dept_po as iam_dept_model,  # noqa: F401
)
from hei_fastapi_ddd.contexts.iam.infrastructure.persistence import (
    group_po as iam_group_model,  # noqa: F401
)
...
from hei_fastapi_ddd.contexts.iam.infrastructure.persistence import (
    position_po as iam_position_model,  # noqa: F401
)
from hei_fastapi_ddd.contexts.iam.infrastructure.persistence import (
    relation_po as iam_relation_model,  # noqa: F401
)
from hei_fastapi_ddd.contexts.iam.infrastructure.persistence import (
    resource_po as iam_resource_model,  # noqa: F401
)
from hei_fastapi_ddd.contexts.iam.infrastructure.persistence import (
    role_po as iam_role_model,  # noqa: F401
)
...
from hei_fastapi_ddd.contexts.sys.infrastructure.persistence import (
    audit_po as audit_model,  # noqa: F401
)
from hei_fastapi_ddd.contexts.sys.infrastructure.persistence import (
    banner_po as banner_model,  # noqa: F401
)
from hei_fastapi_ddd.contexts.sys.infrastructure.persistence import (
    codegen_po as codegen_model,  # noqa: F401
)
from hei_fastapi_ddd.contexts.sys.infrastructure.persistence import (
    dict_po as dict_model,  # noqa: F401
)
from hei_fastapi_ddd.contexts.sys.infrastructure.persistence import (
    feedback_po as feedback_model,  # noqa: F401
)
from hei_fastapi_ddd.contexts.sys.infrastructure.persistence import (
    file_po as file_model,  # noqa: F401
)
from hei_fastapi_ddd.contexts.sys.infrastructure.persistence import (
    job_po as job_model,  # noqa: F401
)
from hei_fastapi_ddd.contexts.sys.infrastructure.persistence import (
    notice_po as notice_model,  # noqa: F401
)
from hei_fastapi_ddd.contexts.sys.infrastructure.persistence import (
    workspace_po as workspace_model,  # noqa: F401
)
