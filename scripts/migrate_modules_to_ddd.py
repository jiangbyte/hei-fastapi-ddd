#!/usr/bin/env python3
"""将 hei-fastapi/app/modules 迁移到 hei-fastapi-ddd contexts 六层结构。

目标布局：api（Schema）/ trigger（HTTP）/ domain（端口）/ application（用例+DTO）/
infrastructure（Impl+wiring）+ 顶层 app/types。已按端口依赖收口，不再生成 interfaces。
...
EXPLICIT: dict[str, str] = {
    ...
    "sys/dict/schema.py": "sys/trigger/http/dict_schemas.py",
    "sys/dict/router.py": "sys/trigger/http/dict_router.py",
    "sys/dict/portal/router.py": "sys/trigger/http/dict_portal_router.py",
    # ---- sys/audit specials ----
    ...
    "sys/audit/schema.py": "sys/trigger/http/audit_schemas.py",
    "sys/audit/router.py": "sys/trigger/http/audit_router.py",
    "sys/audit/portal_router.py": "sys/trigger/http/audit_portal_router.py",
    ...
    "sys/job/schema.py": "sys/trigger/http/job_schemas.py",
    "sys/job/router.py": "sys/trigger/http/job_router.py",
    ...
    "sys/banner/schema.py": "sys/trigger/http/banner_schemas.py",
    "sys/banner/router.py": "sys/trigger/http/banner_router.py",
    "sys/banner/portal/router.py": "sys/trigger/http/banner_portal_router.py",
    ...
    "sys/codegen/schema.py": "sys/trigger/http/codegen_schemas.py",
    "sys/codegen/router.py": "sys/trigger/http/codegen_router.py",
    ...
    "sys/config/schema.py": "sys/trigger/http/config_schemas.py",
    "sys/config/router.py": "sys/trigger/http/config_router.py",
    # ---- sys/feedback ----
    ...
    "sys/feedback/schema.py": "sys/trigger/http/feedback_schemas.py",
    "sys/feedback/router.py": "sys/trigger/http/feedback_router.py",
    ...
    "sys/file/schema.py": "sys/trigger/http/file_schemas.py",
    "sys/file/router.py": "sys/trigger/http/file_router.py",
    "sys/file/portal/router.py": "sys/trigger/http/file_portal_router.py",
    ...
    "sys/notice/schema.py": "sys/trigger/http/notice_schemas.py",
    "sys/notice/router.py": "sys/trigger/http/notice_router.py",
    "sys/notice/enums.py": "sys/domain/notice/enums.py",
    "sys/notice/target_scope.py": "sys/application/notice/target_scope.py",
    # ---- sys/public ----
    "sys/public/router.py": "sys/trigger/http/public_router.py",
    ...
    "sys/weak_password/schema.py": "sys/trigger/http/weak_password_schemas.py",
    "sys/weak_password/router.py": "sys/trigger/http/weak_password_router.py",
    # ---- sys/workspace ----
    ...
    "sys/workspace/schema.py": "sys/trigger/http/workspace_schemas.py",
    "sys/workspace/router.py": "sys/trigger/http/workspace_router.py",
    # ---- internal → sys ----
    "internal/health/router.py": "sys/trigger/http/health_router.py",
    # ---- iam/account ----
    ...
    "iam/account/schema.py": "iam/trigger/http/account_schemas.py",
    "iam/account/router.py": "iam/trigger/http/account_router.py",
    ...
    "iam/client/schema.py": "iam/trigger/http/client_schemas.py",
    "iam/client/router.py": "iam/trigger/http/client_router.py",
    # ---- iam/dept ----
    ...
    "iam/dept/schema.py": "iam/trigger/http/dept_schemas.py",
    "iam/dept/router.py": "iam/trigger/http/dept_router.py",
    ...
    "iam/group/schema.py": "iam/trigger/http/group_schemas.py",
    "iam/group/router.py": "iam/trigger/http/group_router.py",
    # ---- iam/position ----
    ...
    "iam/position/schema.py": "iam/trigger/http/position_schemas.py",
    "iam/position/router.py": "iam/trigger/http/position_router.py",
    # ---- iam/resource ----
    ...
    "iam/resource/schema.py": "iam/trigger/http/resource_schemas.py",
    "iam/resource/router.py": "iam/trigger/http/resource_router.py",
    "iam/resource/portal/router.py": "iam/trigger/http/resource_portal_router.py",
    # ---- iam/role ----
    ...
    "iam/role/schema.py": "iam/trigger/http/role_schemas.py",
    "iam/role/router.py": "iam/trigger/http/role_router.py",
    ...
    "iam/schema.py": "iam/trigger/http/iam_schemas.py",
    ...
    "profile/admin/schema.py": "profile/trigger/http/admin_schemas.py",
    "profile/admin/router.py": "profile/trigger/http/admin_router.py",
    ...
    "profile/portal/schema.py": "profile/trigger/http/portal_schemas.py",
    "profile/portal/router.py": "profile/trigger/http/portal_router.py",
    ...
    "profile/identity/schema.py": "profile/trigger/http/identity_schemas.py",
    "profile/identity/router.py": "profile/trigger/http/identity_router.py",
    ...
    "profile/schema.py": "profile/trigger/http/profile_schemas.py",
    ...
    "auth/schema.py": "auth/trigger/http/auth_schemas.py",
    "auth/session_schema.py": "auth/trigger/http/session_schemas.py",
    "auth/router.py": "auth/trigger/http/auth_router.py",
    "auth/session_admin_router.py": "auth/trigger/http/session_admin_router.py",
    ...
    "auth/oauth/schema.py": "auth/trigger/http/oauth_schemas.py",
    "auth/oauth/router.py": "auth/trigger/http/oauth_router.py",
    ...
    "biz/cg_test_activity/schema.py": "biz/trigger/http/cg_test_activity_schemas.py",
    "biz/cg_test_activity/router.py": "biz/trigger/http/cg_test_activity_router.py",
    ...
    "biz/cg_test_catalog/schema.py": "biz/trigger/http/cg_test_catalog_schemas.py",
    "biz/cg_test_catalog/router.py": "biz/trigger/http/cg_test_catalog_router.py",
    ...
    "biz/cg_test_knowledge_category/schema.py": "biz/trigger/http/cg_test_knowledge_category_schemas.py",
    "biz/cg_test_knowledge_category/router.py": "biz/trigger/http/cg_test_knowledge_category_router.py",
    ...
    "biz/cg_test_order/schema.py": "biz/trigger/http/cg_test_order_schemas.py",
    "biz/cg_test_order/router.py": "biz/trigger/http/cg_test_order_router.py",
}
...
def build_module_rewrites() -> list[tuple[str, str]]:
    ...
    aliases = [
        ...
        ("app.modules.sys.dict.schema", "hei_fastapi_ddd.contexts.sys.api.dict_schemas"),
        ("app.modules.sys.dict.portal.router", "hei_fastapi_ddd.contexts.sys.trigger.http.dict_portal_router"),
        ("app.modules.sys.dict.router", "hei_fastapi_ddd.contexts.sys.trigger.http.dict_router"),
        # account
        ...
        ("app.modules.iam.account.schema", "hei_fastapi_ddd.contexts.iam.api.account_schemas"),
        ...
        ("app.modules.iam.account.router", "hei_fastapi_ddd.contexts.iam.trigger.http.account_router"),
        # auth services
        ...
        ("app.modules.auth.schema", "hei_fastapi_ddd.contexts.auth.api.auth_schemas"),
        ("app.modules.auth.session_schema", "hei_fastapi_ddd.contexts.auth.api.session_schemas"),
        ...
        ("app.modules.auth.oauth.schema", "hei_fastapi_ddd.contexts.auth.api.oauth_schemas"),
        ...
        ("app.modules.iam.client.schema", "hei_fastapi_ddd.contexts.iam.api.client_schemas"),
        ...
        ("app.modules.iam.dept.schema", "hei_fastapi_ddd.contexts.iam.api.dept_schemas"),
        ...
        ("app.modules.iam.group.schema", "hei_fastapi_ddd.contexts.iam.api.group_schemas"),
        ...
        ("app.modules.iam.position.schema", "hei_fastapi_ddd.contexts.iam.api.position_schemas"),
        ...
        ("app.modules.iam.resource.schema", "hei_fastapi_ddd.contexts.iam.api.resource_schemas"),
        ...
        ("app.modules.iam.role.schema", "hei_fastapi_ddd.contexts.iam.api.role_schemas"),
        ...
        ("app.modules.iam.schema", "hei_fastapi_ddd.contexts.iam.api.iam_schemas"),
        ...
        ("app.modules.profile.admin.schema", "hei_fastapi_ddd.contexts.profile.api.admin_schemas"),
        ...
        ("app.modules.profile.portal.schema", "hei_fastapi_ddd.contexts.profile.api.portal_schemas"),
        ...
        ("app.modules.profile.identity.schema", "hei_fastapi_ddd.contexts.profile.api.identity_schemas"),
        ...
        ("app.modules.profile.schema", "hei_fastapi_ddd.contexts.profile.api.profile_schemas"),
        ...
        ("app.modules.sys.audit.schema", "hei_fastapi_ddd.contexts.sys.api.audit_schemas"),
        ...
        ("app.modules.sys.job.schema", "hei_fastapi_ddd.contexts.sys.api.job_schemas"),
        ...
        ("app.modules.sys.banner.schema", "hei_fastapi_ddd.contexts.sys.api.banner_schemas"),
        ...
        ("app.modules.sys.codegen.schema", "hei_fastapi_ddd.contexts.sys.api.codegen_schemas"),
        ...
        ("app.modules.sys.config.schema", "hei_fastapi_ddd.contexts.sys.api.config_schemas"),
        ...
        ("app.modules.sys.feedback.schema", "hei_fastapi_ddd.contexts.sys.api.feedback_schemas"),
        ...
        ("app.modules.sys.file.schema", "hei_fastapi_ddd.contexts.sys.api.file_schemas"),
        ...
        ("app.modules.sys.notice.schema", "hei_fastapi_ddd.contexts.sys.api.notice_schemas"),
        ...
        ("app.modules.sys.weak_password.schema", "hei_fastapi_ddd.contexts.sys.api.weak_password_schemas"),
        ...
        ("app.modules.sys.workspace.schema", "hei_fastapi_ddd.contexts.sys.api.workspace_schemas"),
        # biz
        ...
        ("app.modules.biz.cg_test_activity.schema", "hei_fastapi_ddd.contexts.biz.api.cg_test_activity_schemas"),
        ...
        ("app.modules.biz.cg_test_catalog.schema", "hei_fastapi_ddd.contexts.biz.api.cg_test_catalog_schemas"),
        ...
        ("app.modules.biz.cg_test_knowledge_category.schema", "hei_fastapi_ddd.contexts.biz.api.cg_test_knowledge_category_schemas"),
        ...
        ("app.modules.biz.cg_test_order.schema", "hei_fastapi_ddd.contexts.biz.api.cg_test_order_schemas"),
    ]
